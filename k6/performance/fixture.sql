...
INSERT INTO cart_items
  (id, cart_id, product_id, product_name, quantity, price, size, discount_percent, discounted_price, created_at, updated_at)
SELECT id, id,
       1 + ((id - 100000) % 10),
...
INSERT INTO orders
  (id, order_date, order_status, original_price, discount, payment_method, payment_status, total_discounted_price, total_items, user_id, user_email)
SELECT 9000000 + i, now(), 'PENDING', 100, 0, 'VNPAY', 'PENDING', 100, 1,
...
BEGIN;
UPDATE sizes SET quantity = 100000 WHERE id IN (1,4,6,8,10,12,14,16,18,20);
COMMIT;
