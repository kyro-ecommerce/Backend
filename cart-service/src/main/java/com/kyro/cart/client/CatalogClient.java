...
public interface CatalogClient {
  ...
  ProductResponse getProductById(@PathVariable("productId") Long id);

  @PostMapping("/api/v1/internal/products/lookup")
  List<ProductResponse> getProducts(@RequestBody ProductLookupRequest r);
