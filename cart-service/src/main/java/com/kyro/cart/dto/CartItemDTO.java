...
public class CartItemDTO {
  private Long id, productId, variantId;
  private String productName, sku, variantName, productImageUrl;
  private int quantity, discountPercent;
  private long price, salePrice;
  private boolean available = true, priceChanged;
  ...
  public void setUnavailableReason(String v) {
    unavailableReason = v;
  }
  ...
  public void setPriceChanged(boolean v) {
    priceChanged = v;
  }
}
