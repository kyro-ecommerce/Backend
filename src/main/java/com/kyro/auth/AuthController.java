...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> registerUser(@RequestBody RegisterRequest request) {
        ...
        return ResponseEntity.ok(Map.of("message", "Mã xác thực đã được gửi tới email. Vui lòng kiểm tra và xác thực."));
    }
    ...
    public ResponseEntity<Map<String, String>> resendOtp(@RequestBody Map<String, String> request) {
        ...
        return ResponseEntity.ok(Map.of("message", "Mã OTP mới đã được gửi tới email. Vui lòng kiểm tra hộp thư của bạn."));
    }

    @PostMapping("/register/forgot-password")
    public ResponseEntity<Map<String, String>> forgotPass(@RequestBody ForgotPasswordRequest forgotPasswordRequest) {
