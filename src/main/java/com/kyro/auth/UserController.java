...
public class UserController {
    ...
    @PutMapping("/update")
    public ResponseEntity<Map<String, String>> updateUser(@RequestBody UpdateUserRequest request, @RequestHeader("Authorization") String jwt) {
    ...
    @Transactional
    public ResponseEntity<Map<String, String>> addUserAddress(@RequestHeader("Authorization") String jwt,
