...
public class AdminProductController {
    ...
    public ResponseEntity<Map<String, String>> deleteProduct(@PathVariable Long productId) {
        ...
        return ResponseEntity.ok(Map.of("message", String.format("Delete product have ID %d successfully", productId)));
    }
    ...
    public ResponseEntity<Map<String, String>> createMultipleProducts(@RequestBody CreateProductRequest[] requests) {
