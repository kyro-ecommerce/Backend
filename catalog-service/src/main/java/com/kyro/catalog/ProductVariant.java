...
public class ProductVariant {
  ...
  @NotBlank @Column(nullable = false, length = 100) private String sku;
  @NotBlank @Column(name = "variant_name", nullable = false) private String variantName;
  @PositiveOrZero @Column(nullable = false) private long price;
  @PositiveOrZero @Column(nullable = false) private int stock;
  ...
  public void setPrice(long value) { price = value; }
