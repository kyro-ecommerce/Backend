...
public class Product {
  ...
  @NotBlank @Size(max = 100) @Column(nullable = false, length = 100) private String title;
  @Size(max = 500) @Column(columnDefinition = "TEXT") private String description;
  ...
  @Formula("(select coalesce(min(v.price),0) from product_variant v where v.product_id=id and v.active=true)")
  private long minPrice;
  @Formula("(select coalesce(sum(v.stock),0) from product_variant v where v.product_id=id and v.active=true)")
  ...
  public String getDetailedReview() { return detailedReview; }
  public void setDetailedReview(String value) { detailedReview = value; }
  ...
  public void setVariants(List<ProductVariant> value) { variants = value; value.forEach(v -> v.setProduct(this)); }
  public List<ProductAttribute> getAttributes() { return attributes; }
  public void setAttributes(List<ProductAttribute> value) { attributes = value; value.forEach(a -> a.setProduct(this)); }
  public List<Image> getImages() { return images; }
  public void setImages(List<Image> value) { images = value; }
  public List<Review> getReviews() { return reviews; }
  public void setReviews(List<Review> value) { reviews = value; }
  public LocalDateTime getCreatedAt() { return createdAt; }
  public void setCreatedAt(LocalDateTime value) { createdAt = value; }
  public long getMinPrice() { return minPrice; }
  public int getTotalStock() { return totalStock; }
  public int getActiveVariantCount() { return activeVariantCount; }
